export const IconArrowRight = ({size=16,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconDashboard = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconTransactions = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 1v22M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"/></svg>
);
export const IconDepenses = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconGouvernance = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconEquipement = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22 17H2l2-2h16l2 2z"/><path d="M12 15V5"/><circle cx="12" cy="5" r="3"/><path d="M10 15h4"/></svg>
);
export const IconSettings = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconBell = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconMenu = ({size=24,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconX = ({size=24,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconTractor = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="16" cy="18" r="3"/><circle cx="6" cy="18" r="3"/><path d="M3 18v-5l3-2 4-3h4l3 3 3 2v5"/><path d="M10 8V5h4v3"/><line x1="10" y1="13" x2="14" y2="13"/></svg>
);
export const IconShield = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z"/></svg>
);
export const IconCheck = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconTarget = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconEye = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconHeart = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconMail = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconClock = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconSend = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconPhone = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconMapPin = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconDollar = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconArrowLeftRight = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m16 3 4 4-4 4"/><path d="M20 7H4"/><path d="m8 21-4-4 4-4"/><path d="M4 17h16"/></svg>
);

export const IconUsers = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconLock = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconBarChart = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><line x1="12" y1="20" x2="12" y2="10"/><line x1="18" y1="20" x2="18" y2="4"/><line x1="6" y1="20" x2="6" y2="16"/></svg>
);
...
export const IconTrendingUp = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconFileText = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/><line x1="16" y1="13" x2="8" y2="13"/><line x1="16" y1="17" x2="8" y2="17"/><polyline points="10 9 9 9 8 9"/></svg>
);

export const IconVote = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="m9 12 2 2 4-4"/><rect x="3" y="5" width="18" height="14" rx="2"/><path d="M12 5v14"/></svg>
);

export const IconAlertTriangle = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
...
export const IconCreditCard = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" stroke={color} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect x="1" y="4" width="22" height="16" rx="2" ry="2"/><line x1="1" y1="10" x2="23" y2="10"/></svg>
);

export const IconDownload = ({size=20,color='currentColor'}:{size?:number,color?:string}) => (
